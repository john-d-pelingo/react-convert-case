...
describe('Text reducer', () => {
  ...
  describe('SET_CAMEL_CASE', () => {
    describe('with lastCased', () => {
      it('should update current and last cased texts', () => {
        const nextState = textReducer(initialState, {
          type: SET_CAMEL_CASE,
          payload: {
    ...
    describe('without lastCased', () => {
      it('should update current, initial and last cased texts', () => {
        const state = {
          ...initialState,
          lastCased: ''
        };
        ...
        expect(nextState.copied).toBe(initialState.copied);
        expect(nextState.current).toBe('');
        expect(nextState.initial).toBe(newText);
        expect(nextState.lastCased).toBe('');
      });
    });
  });
